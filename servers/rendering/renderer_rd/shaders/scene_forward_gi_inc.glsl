...
#define MAX_CONE_DIRS 4
	...
	//irradiance
	vec4 irr_light = voxel_cone_trace(voxel_gi_textures[index], cell_size, position, ref_vec, tan(roughness * 0.5 * M_PI * 0.99), max_distance, voxel_gi_instances.data[index].reflection_bias);
	if (voxel_gi_instances.data[index].blend_ambient) {
